...
-- 상품 테이블
INSERT INTO products (product_id, category_id, user_id, name, image_url, brand, base_price, discount_rate, description, shipping_price, status, created_at, updated_at)
VALUES
    (100, 2, 10, '고급 의자', 'https://a.jpg', '홈스윗', 10000, 0.00, '좋은 의자', 3000, 'ON_SALE', NOW(), NOW()),
    (101, 2, 10, '저가 의자', 'https://b.jpg', '가구나라', 5000, 0.00, '싼 의자', 3000, 'ON_SALE', NOW(), NOW()),
    (102, 3, 11, '책상 세트', 'https://c.jpg', '홈스윗', 30000, 0.00, '좋은 책상', 3000, 'ON_SALE', NOW(), NOW()),
    (103, 3, 11, '판매 중지 상품', 'https://d.jpg', '가구나라', 15000, 0.00, '품절 상품', 3000, 'SUSPENDED', NOW(), NOW());

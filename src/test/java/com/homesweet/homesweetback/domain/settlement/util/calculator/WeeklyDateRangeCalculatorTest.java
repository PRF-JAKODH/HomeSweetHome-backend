...
class WeeklyDateRangeCalculatorTest {
    ...
    @Test
    @DisplayName("[성공] monday()는 월요일을 반환한다")
    void monday_success() {
    ...
    @Test
    @DisplayName("[성공] sunday()는 일요일을 반환한다")
    void sunday_success() {
    ...
    class getWeeklyDateRangeFail {
        @Test
        @DisplayName("[실패] startDate가 null이면 NullPointerException")
        ...
        @Test
        @DisplayName("[실패] endDate가 null이면 NullPointerException")
        ...
        @Test
        @DisplayName("[실패] monday()에 null 전달 시 NPE 발생")
        ...
        @Test
        @DisplayName("[실패] sunday()에 null 전달 시 NPE 발생")

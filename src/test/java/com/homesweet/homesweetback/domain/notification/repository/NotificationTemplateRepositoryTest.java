...
public class NotificationTemplateRepositoryTest {
    ...
    public void dbSetup() throws Exception {          
        try (Connection conn = dataSource.getConnection()) {             
            ScriptUtils.executeSqlScript(conn, new ByteArrayResource(INIT_SQL.getBytes(StandardCharsets.UTF_8)));          
        }    
    }
    ...
    public void get_notification_template_by_type_success() {
        NotificationEventType notificationEventType = NotificationEventType.NEW_COMMENT_LIKE;

...
// import
// com.homesweet.homesweetback.domain.community.repository.CommunityCommentLikeRepository;
// import
// com.homesweet.homesweetback.domain.community.repository.CommunityCommentRepository;
// import
// com.homesweet.homesweetback.domain.community.repository.CommunityPostLikeRepository;
// import
// com.homesweet.homesweetback.domain.community.repository.CommunityPostRepository;
// import
// com.homesweet.homesweetback.domain.community.service.CommunityRedisService;
// import
// com.homesweet.homesweetback.domain.community.service.CommunityRedisService.LikeEvent;
...
// log.debug("View count synced to DB - postId: {}, viewCount: {}", postId,
// viewCount);
// } else {
...
// log.info("View count sync completed - total processed: {}",
// viewCounts.size());
// }
...
// redisService.scanAndCollectCommentCounts();
...
// if (affected > 0) {
// // DB 동기화 성공 시 Redis 값 유지 (Cache-Aside 패턴)
// log.debug("Comment count synced to DB - postId: {}, commentCount: {}",
// postId, commentCount);
// } else {
// // 게시글이 삭제된 경우 Redis 키 정리
...
// log.info("Comment count sync completed - total processed: {}",
// commentCounts.size());
// }
...
// if (affected > 0) {
// // DB 동기화 성공 시 Redis 값 유지 (Cache-Aside 패턴)
// log.debug("Post like count synced to DB - postId: {}, likeCount: {}", postId,
// likeCount);
// } else {
// // 게시글이 삭제된 경우 Redis 키 정리
...
// log.info("Post like count sync completed - total processed: {}",
// likeCounts.size());
// }
...
// counts[0]++;
// } else {
// commentLikeRepository.deleteByCommentIdAndUserId(event.targetId(),
// event.userId());
// counts[1]++;
// }
// } catch (Exception e) {
...
// redisService.scanAndCollectCommentLikeCounts();
...
// if (affected > 0) {
// // DB 동기화 성공 시 Redis 값 유지 (Cache-Aside 패턴)
// log.debug("Comment like count synced to DB - commentId: {}, likeCount: {}",
// commentId, likeCount);
// } else {
...
// }
// } catch (Exception e) {
// log.error("Failed to update comment like count for commentId: {}", commentId,
// e);
// }
// });
// });

// log.info("Comment like count sync completed - total processed: {}",
// likeCounts.size());
// }
// }
...
// import
// com.homesweet.homesweetback.domain.settlement.repository.DailySettlementRepository;
// import
// com.homesweet.homesweetback.domain.settlement.repository.SettlementRepository;
...
// LogManager.getLogger(SettlementScheduler.class);
...
// // target.minusDays(1).withHour(23).withMinute(59).withSecond(59);
// LocalDateTime cutoffTime = LocalDateTime.now(KST);
// log.info("정산 생성 실행");
// List<Order> canceledOrders =
// settlementRepository.findUnSettlementOrders(OrderStatus.COMPLETED,
// cutoffTime);
...
// log.info("정산 취소 실행");
// List<Order> canceledOrders =
// settlementRepository.findCancelSettlement(DeliveryStatus.CANCELLED,
// cutoffTime);
...
// userRepository.findAllByRole(UserRole.SELLER).forEach(seller -> {
// try {
// weeklySettlementService.getWeeklySettlement(seller.getId(), weekStart,
// weekEnd);
// } catch (Exception e) {
// e.printStackTrace(System.out);
// }
